...
import pigdm.jspacefight.model.Bullet;
import pigdm.jspacefight.model.Enemy;
...
public class GamePanel extends JPanel implements ActionListener {
    ...
    public GamePanel() {
        ...
        ImageIcon backgroundImage = new ImageIcon(Objects.requireNonNull(getClass().getClassLoader().getResource("pigdm/jspacefight/images/background.png")));
    ...
    private void initEnemy() {
        ...
        ProxyImage enemyOneImage = new ProxyImage("pigdm/jspacefight/images/enemy_1.gif");
        ProxyImage enemyTwoImage = new ProxyImage("pigdm/jspacefight/images/enemy_2.gif");
        ...
        if (playing) {
            ...
            if (boolP2 == true) {
                if (playerTwo.isDead() == false) {
                    ImageIcon shipTwoImage = new ImageIcon(Objects.requireNonNull(getClass().getClassLoader().getResource("pigdm/jspacefight/images/ship_2.gif")));
            ...
            ImageIcon gameWonImage = new ImageIcon(Objects.requireNonNull(getClass().getClassLoader().getResource("pigdm/jspacefight/images/game_won.jpg")));
            graphics2D.drawImage(gameWonImage.getImage(), 0, 0, null);
        }
        else if (begin) {
            ImageIcon mainMenuImage = new ImageIcon(Objects.requireNonNull(getClass().getClassLoader().getResource("pigdm/jspacefight/images/main_menu.jpg")));
            image = mainMenuImage.getImage();
            graphics2D.drawImage(image, 0, 0, null);
        }
        else {
            ImageIcon gameOverImage = new ImageIcon(Objects.requireNonNull(getClass().getClassLoader().getResource("pigdm/jspacefight/images/game_over.jpg")));
